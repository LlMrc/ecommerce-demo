...
const TopMenu = () => {
  ...
  return (
    <div className="h-[101px] p-9 bg-skin-base flex justify-between items-center">
      <div className="flex">
        <h1 className="text-white  font-[600px] text-[40px] not-italic leading-[19px]">
          MKS
        </h1>
        <span className="not-italic pl-2 text-[20px] font-[300px] leading-[19px] text-white">
          Sistemas
        </span>
      </div>
      <div className="w-[90px] h-[45px] shrink-0 rounded-[8px] bg-skin-bg text-white justify-evenly items-center flex">
        <svg
          className="fill-none h-[18px] w-[19px] "
